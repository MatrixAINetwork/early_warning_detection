...
x = igbt_GATE_CURRENT[300000:301680]
y = igbt_COLLECTOR_CURRENT[300000:301680]
z = igbt_COLLECTOR_VOLTAGE[300000:301680]
...
if(split_list[length(split_list)] < total_len){
  start_i = split_list[length(split_list)]
  end_i = total_len
  sub_ = data[c(start_i:end_i),]
